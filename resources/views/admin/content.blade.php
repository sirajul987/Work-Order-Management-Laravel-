          ...
          <div class="row gutter-xs">
            ...
            <div class="col-xs-6 col-md-3">
              <div class="card">
                ...
                <div class="card-chart">
                  <canvas data-chart="line" data-animation="false" data-labels='["Jun 21", "Jun 20", "Jun 19", "Jun 18", "Jun 17", "Jun 16", "Jun 15"]' data-values='[{"colorStop1": "#cbdff1", "colorStop2": "#ffffff", "y0": 0, "y1": 36,"borderColor": "#1c90fb", "data": [8796, 11317, 8678, 9452, 8453, 11853, 9945]}]' data-scales='{"yAxes": [{ "ticks": {"max": 12853}}]}' data-hide='["legend", "points", "scalesX", "scalesY", "tooltips"]' height="50"></canvas>
                </div>
              </div>
            </div>
            <div class="col-xs-6 col-md-3">
            ...
            <div class="col-xs-6 col-md-3">
              <div class="card">
                ...
                <div class="card-chart">
                  <canvas data-chart="line" data-animation="false" data-labels='["Jun 21", "Jun 20", "Jun 19", "Jun 18", "Jun 17", "Jun 16", "Jun 15"]' data-values='[{"colorStop1": "#cbdff1", "colorStop2": "#ffffff", "y0": 0, "y1": 36,"borderColor": "#1c90fb", "data": [13590442, 12362934, 13639564, 13055677, 12915203, 11009940, 11542408]}]' data-scales='{"yAxes": [{ "ticks": {"max": 14662531}}]}' data-hide='["legend", "points", "scalesX", "scalesY", "tooltips"]' height="50"></canvas>
                </div>
              </div>
            </div>
          </div>
          <div class="row gutter-xs">
            ...
            <div class="col-xs-12 col-md-6">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="card-chart">
                    <canvas data-chart="bar" data-animation="false" data-labels='["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"]' data-values='[{"label": "This week", "backgroundColor": "#1c90fb", "borderColor": "#1c90fb", "data": [23167, 15991, 13905, 17447, 24558, 22594, 23067]}, {"label": "Last week", "backgroundColor": "#2cf0d9", "borderColor": "#2cf0d9", "data": [7374, 16740, 22929, 16788, 12103, 16459, 24058]}]' data-tooltips='{"mode": "label"}' data-hide='["gridLinesX", "legend", "points"]' data-scales='{"yAxes": [{"gridLines": {"color": "#f5f5f5"}, "ticks": {"fontColor": "#bcc1c6", "maxTicksLimit": 5}}], "xAxes": [{ "gridLines": {"color": "#f5f5f5"}, "ticks": {"fontColor": "#bcc1c6"}} ]}' height="128"></canvas>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="media">
                    <div class="media-middle media-left">
                      <div class="media-chart">
                        <canvas data-chart="doughnut" data-animation="false" data-labels='["Resolved", "Unresolved"]' data-values='[{"backgroundColor": ["#1c90fb", "#667589"], "data": [879, 377]}]' data-hide='["legend", "scalesX", "scalesY", "tooltips"]' height="64" width="64"></canvas>
                      </div>
                    </div>
                    <div class="media-middle media-body">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="media">
                    <div class="media-middle media-left">
                      <div class="media-chart">
                        <canvas data-chart="doughnut" data-animation="false" data-labels='["Resolved", "Unresolved"]' data-values='[{"backgroundColor": ["#667589", "#1c90fb"], "data": [879, 377]}]' data-hide='["legend", "scalesX", "scalesY", "tooltips"]' height="64" width="64"></canvas>
                      </div>
                    </div>
                    <div class="media-middle media-body">
                      <h2 class="media-heading">
                      ...
                      <table class="table table-borderless table-middle">
                        <tbody>
                          <tr>
                            ...
                            <td class="col-xs-6">
                              <a class="link-muted" href="index.html#">/getting-started</a>
                            </td>
                            <td class="col-xs-2">
                          ...
                          <tr>
                            ...
                            <td class="col-xs-6">
                              <a class="link-muted" href="index.html#">/pricing</a>
                            </td>
                            <td class="col-xs-2">
                              <div class="text-right">185,118</div>
                            </td>
                          ...
                          <tr>
                            ...
                            <td class="col-xs-6">
                              <a class="link-muted" href="index.html#">/blog</a>
                            </td>
                            <td class="col-xs-2">
                          ...
                          <tr>
                            ...
                            <td class="col-xs-6">
                              <a class="link-muted" href="index.html#">/support</a>
                            </td>
                            <td class="col-xs-2">
                          ...
                          <tr>
                            ...
                            <td class="col-xs-6">
                              <a class="link-muted" href="index.html#">/about-us</a>
                            </td>
                            <td class="col-xs-2">
                    ...
                    <div class="card-body">
                      ...
                      <div class="card-phrases">
                        <div class="text-justify">
                          <a class="link-muted" href="index.html#" title="Search nodejs" style="font-size: 11px">nodejs</a>
                          <a class="link-muted" href="index.html#" title="Search modernizr" style="font-size: 9px">modernizr</a>
                          <a class="link-muted" href="index.html#" title="Search babel" style="font-size: 14px">babel</a>
                          <a class="link-muted" href="index.html#" title="Search elephant" style="font-size: 36px">elephant</a>
                          <a class="link-muted" href="index.html#" title="Search admin" style="font-size: 13px">admin</a>
                          <a class="link-muted" href="index.html#" title="Search package" style="font-size: 9px">package</a>
                          <a class="link-muted" href="index.html#" title="Search gruntjs" style="font-size: 12px">gruntjs</a>
                          <a class="link-muted" href="index.html#" title="Search underscore" style="font-size: 9px">underscore</a>
                          <a class="link-muted" href="index.html#" title="Search jquery" style="font-size: 20px">jquery</a>
                          <a class="link-muted" href="index.html#" title="Search material" style="font-size: 9px">material</a>
                          <a class="link-muted" href="index.html#" title="Search material-design" style="font-size: 11px">material-design</a>
                          <a class="link-muted" href="index.html#" title="Search validation" style="font-size: 11px">validation</a>
                          <a class="link-muted" href="index.html#" title="Search angularjs" style="font-size: 24px">angularjs</a>
                          <a class="link-muted" href="index.html#" title="Search react" style="font-size: 14px">react</a>
                          <a class="link-muted" href="index.html#" title="Search requirejs" style="font-size: 9px">requirejs</a>
                          <a class="link-muted" href="index.html#" title="Search form" style="font-size: 9px">form</a>
                          <a class="link-muted" href="index.html#" title="Search widgets" style="font-size: 14px">widgets</a>
                          <a class="link-muted" href="index.html#" title="Search sass" style="font-size: 23px">sass</a>
                          <a class="link-muted" href="index.html#" title="Search chartjs" style="font-size: 9px">chartjs</a>
                          <a class="link-muted" href="index.html#" title="Search theme" style="font-size: 14px">theme</a>
                          <a class="link-muted" href="index.html#" title="Search api" style="font-size: 33px">api</a>
                          <a class="link-muted" href="index.html#" title="Search gulp" style="font-size: 10px">gulp</a>
                          <a class="link-muted" href="index.html#" title="Search bootstrap" style="font-size: 23px">bootstrap</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-body">
                  <div class="timeline">
                    ...
                    <div class="timeline-item">
                      ...
                      <div class="timeline-content">
                        <div class="timeline-row">
                          <a href="index.html#">Harry Jones</a>
                    ...
                    <div class="timeline-item">
                      ...
                      <div class="timeline-content">
                        <div class="timeline-row">
                          <a href="index.html#">Teddy Wilson</a>
                          <small>5 min ago</small>
                        </div>
                        <div class="timeline-row">
                    ...
                    <div class="timeline-item">
                      ...
                      <div class="timeline-content">
                        <div class="timeline-row">
                          <a href="index.html#">Daniel Taylor</a>
                    ...
                    <div class="timeline-item">
                      ...
                      <div class="timeline-content">
                        ...
                        <div class="timeline-row">
                          A repository <a href="index.html#">elephant</a> was created.
                        </div>
                      </div>
                    </div>
                  </div>
